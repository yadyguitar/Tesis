...
Para ello, se debe tener en cuenta que para que el usuario pueda ver todos los ángulos del escenario proyectado, la proyección debe estar en el medio de un entorno en donde se pueda caminar alrededor de éste y así poder abarcar los 360$^{\circ}$. Para ver la información virtual mas cercana al observador se puede mostrar la proyección en una mesa (tabletop), de tal modo que se pudiese (como trabajo futuro) interactuar con la información a través de las manos o gestos.\\
\begin{figure}
	\centering
...
Para diseñar el escenario virtual existen varios programas multiplataformas como por ejemplo Blender o Unity (ambos se consideran motores de juegos o game engine en inglés), en donde su principal diferencia radica en la compatibilidad con los lenguajes, por ejemplo Blender permite scripts en python mientras que Unity admite c, c++ y c\#. Como el propósito en éste trabajo de tesis es mas que nada proponer una técnica que permita ver un objeto virtual 3D, la tarea principal con respecto a la creación de los elementos virtuales sería el modelado de ellos, por lo que Blender está mas enfocado a ésta área y es muy sencillo de utilizar.\\
...
A partir del análisis previo de los componentes que podrían conformar el sistema, a continuación se mencionan los  necesarios que se involucrarán en el desarrollo del sistema. Se debe tener en cuenta que la elección de los recursos que intervendrán en éste principalmente estará basado en la opción más económica posible y algunos serán proporcionados por parte de la Universidad Veracruzana.
\vspace*{10 mm}
...
\begin{figure}[H]
	\centering
	\subfigure{\includegraphics[width=140mm]{./figuras/prueba1}}
	\subfigure{\includegraphics[width=140mm]{./figuras/prueba2}}
...
En cuanto al rendimiento general del sistema, como fue mencionado, el sensor utilizado captura 30 imágenes (frames) por segundo, y debido a los cálculos que se realizan en cada imagen, se hizo un análisis de cuantos frames realmente se obtienen en un segundo, dando como resultado el mismo número (30 fps), lo cual concluye que el uso de python no alentece el subsistema en la Terminal.\\
...
\begin{figure}[H]
	...
	\caption{Área de detección dependiendo de altura de la persona}\label{fig:frontretro}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
