...
\begin{figure}[th]
	\centering
	\includegraphics[width=45mm]{./figuras/proto1}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=40mm]{./figuras/deteccionManual}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=50mm]{./figuras/posicion}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=45mm]{./figuras/proyeccionProto1}
...
A partir del análisis de lo que se pretende realizar, a continuación se describen los componentes necesarios que se involucrarán en el desarrollo del sistema. Se debe tener en cuenta que la elección de los recursos que intervendrán en el sistema principalmente estará basado en la opción más económica posible y algunos serán proporcionados por parte de la Universidad Veracruzana.
