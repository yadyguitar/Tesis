...
Éste módulo es basado en la técnica usada en el anterior, la detección manual, el cual se basa en el mismo concepto de ajustar un umbral de tal modo que solo se pueda determinar la cabeza de la persona y así poder marcar el contorno y proceder a los modulos siguientes. La diferencia entonces, la encontramos en que desde un inicio el umbral se ajusta de manera automática, de tal modo que si una persona de mayor o menor altura, siempre se determinará un rango de área determinada. El área se determinará a través de un rectangulo debido a la irregularidad de la forma generada por el contorno determinada por la imagen de profundidad y para que sea un modelo de aproximación.
