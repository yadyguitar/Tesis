...
En esta sección se muestran los resultados finales del sistema, en donde se puede apreciar la perspectiva de una persona desde distintos puntos del área de detección en condiciones de iluminación normal. Fueron incluidas las imágenes directamente del programa Blender\textcopyright, para que se pueda apreciar como se comporta la rotación de la ventana de visualización con base en la posición donde se encuentre la persona. En las figuras \ref{fig:prueba1}, \ref{fig:prueba2}, \ref{fig:prueba3} y \ref{fig:prueba4} se muesta el proceso de detección de la posición de la persona por pasos hasta llegar a la proyección del escenario mostrado desde la perspectiva de la persona. Del mismo modo, la figura () muestra unos segundos subsecuentes de la figura (4) pero con un acercamiento de la persona al escenario, en donde se puede notar un leve aumento de la imagen. Las figuras (), muestran una secuencia similar a las anteriores pero con dos personas, en donde se puede notar en el filtro que se realiza en las imágenes con número 3, se detecta que si en un frame interviene una persona que no sea la principal, se le aplica un filtro de color blanco (fondo) para poder seguir a la persona principal. En la figura se muestra como la perspectiva proyectada es únicamente de la persona principal.
\begin{figure}[th]
	\centering
	\hspace*{-1cm}
...
\begin{figure}[th]
	...
	\caption[Resultado 6]{Resultado 6. Figura 1-4: Tratamiento de la imagen para obtener la posición y altura (1: Imagen Depth, 2: Imagen Binarizada, 3: Filtro para excluir persona adicional al entorno, 4: Detección de centroide de la persona principal). Figura 5: Imagen capturada del programa Blender\textcopyright. Figura 7: Proyección desde la perspectiva de la persona}\label{fig:prueba6}
\end{figure}
...
\begin{figure}[th]
	...
	\caption[Resultado 7]{Resultado 7. Figura 1-4: Tratamiento de la imagen para obtener la posición y altura (1: Imagen Depth, 2: Imagen Binarizada, 3: Filtro para excluir persona adicional al entorno, 4: Detección de centroide de la persona principal). Figura 5: Imagen capturada del programa Blender\textcopyright. Figura 7: Proyección desde la perspectiva de la persona acercándose al escenario}\label{fig:prueba7}
\end{figure}
