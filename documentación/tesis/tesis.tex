...
\AddToShipoutPicture*{\hspace*{-6mm}\put(0,0){\includegraphics[scale=1]{indice.pdf}}}
\shipout\null
%%%DEDICATORIA%%%
\chapter*{}
\pagenumbering{Roman}
...
\begin{figure}[th]
	\centering
	\subfigure[Simulador clínico de examen de mama, extraído de \citep{kotranza2009} ]{\includegraphics[width=60mm]{./figuras/medicinaAR1}}
	\subfigure[Simulador de operación, explicado en \citep{bichlmeier2007} ]{\includegraphics[width=60mm]{./figuras/medicinaAR2}}
...
\begin{figure}
	\centering
	\subfigure[Proyección frontal]{\includegraphics[width=60mm]{./figuras/frontProj}}
	\subfigure[Retroproyección]{\includegraphics[width=60mm]{./figuras/rearProj}}
...
\begin{figure}[tbh]
	\centering
	\includegraphics[width=50mm]{./figuras/esquemaGeneral}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=130mm]{./figuras/proto1}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=130mm]{./figuras/deteccionManual}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=140mm]{./figuras/posicion}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=130mm]{./figuras/proyeccionProto1}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=140mm]{./figuras/proto2}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=40mm]{./figuras/proyeccionProto2}
...
\begin{figure}[th]
	\centering
	\includegraphics[width=140mm]{./figuras/sistemaGeneral}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=130mm]{./figuras/escenarioEspec}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=130mm, height=135mm]{./figuras/mainProto1}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=70mm, height=50mm]{./figuras/equivX}
...
Las instrucciones iniciales de éste método siguen las mismas que las del método manual (desarrollo en el prototipo 1), es decir, se obtienen las imágenes Depth y RGB y luego se le aplican los filtros para eliminar un poco el ruido generado por el sensor. La parte que difiere, es en el ajuste del umbral, que en éste caso se realiza de forma automática y que en el capítulo anterior, se dió una idea general de como se realizaría éste ajuste. La imagen de profundidad capturada por el sensor, nos proporciona una matriz con valores que indica la profundidad en cada píxel, los cuales oscilan entre 0 y 255; en donde 0 significa que no ha sido posible obtener la información; 1 es la distancia mas cercana al sensor y 255 la más lejana. Fue propuesto entonces, escanear la imagen en niveles de profundidad, donde se empieza inicialmente con valor de umbral 1, y aumentar su valor de forma constante, es decir con un valor de aumento de 1, hasta encontrar un objeto en la imagen, obtener su contorno y delimitarlo en un rectángulo para aproximar la figura determinada. Luego de ésto se calcula el área del rectángulo y se compara con un rango de área establecido (4000 px$^2$- 9000 px$^2$). Si el área actual se encuentra dentro de ese rango, se determina que se encontró a la persona y se continúa con las demás etapas; en caso contrario dependiendo de si es mayor o menor el área calculada en relación al rango determinado, se aumentará o disminuirá el umbral. Aunque el valor de profundidad pueda ser hasta 255, realmente no necesitamos llegar hasta ese valor debido a que únicamente se requiere determinar la altura de una persona por encima de la mesa. Es por ello que se define como umbral máximo de detección un valor $C$ constante de 153, que es el valor dado de profundidad donde se encuentra la superficie de la mesa (con el sensor ubicado a 2.90 m de altura(véase figura \ref{fig:valorProf})), y de ésta manera la detección se realizará en un rango de profundidad entre 1 y $C$. \begin{figure}[H]
	\centering
	\includegraphics[width=130mm]{./figuras/valoresProf}
...
\begin{figure}[H]
	\centering
	\subfigure[Detección de la persona excluyendo la mano]{\includegraphics[width=120mm]{./figuras/deteccAutoManos1}}
	\subfigure[Detección de la persona excluyendo ambas manos]{\includegraphics[width=120mm]{./figuras/deteccAutoManos2}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=135mm]{./figuras/deteccAutoPersonas1}
...
\begin{algorithm}[p]
	...
	\While{Area Actual $<$ valor minimo o Area Actual $>$ valor maximo}{
		...
		\If{Hay contornos}{
			...
			\If{distancia $>$ 40}{
				Modificar imagen Depth dibujando de color blanco la region donde se encuentra el rectangulo que contiene el contorno detectado\;
				Area Actual$\rightarrow$ 0; Hay otra persona$\rightarrow$ \textbf{True}\;
...
En esta sección se muestran los resultados finales del sistema, en donde se puede apreciar la perspectiva de una persona desde distintos puntos del área de detección en condiciones de iluminación normal. Fueron incluidas las imágenes directamente del programa Blender\textcopyright, para que se pueda apreciar como se comporta la rotación de la ventana de visualización con base en la posición donde se encuentre la persona. En las figuras \ref{fig:prueba1}, \ref{fig:prueba2}, \ref{fig:prueba3} y \ref{fig:prueba4} se muesta el proceso de detección de la posición de la persona por pasos hasta llegar a la proyección del escenario mostrado desde la perspectiva de la persona. Del mismo modo, la figura \ref{fig:prueba5} muestra unos segundos subsecuentes de la figura \ref{fig:prueba4} pero con un acercamiento de la persona al escenario, en donde se puede notar un leve aumento de la imagen. Las figuras \ref{fig:prueba6}, \ref{fig:prueba7} y \ref{fig:prueba8} muestran una secuencia similar a las anteriores pero con dos personas, en donde se puede notar que en las imágenes con número 3, se detecta si en un frame interviene una persona que no sea la principal y se le aplica un filtro de color blanco (fondo) para poder seguir a la persona principal. En la figura \ref{fig:prueba8} se muestra como la perspectiva proyectada es únicamente de la persona principal.
\begin{figure}[th]
	\centering
	\hspace*{-1cm}
	\includegraphics[width=160mm,height=130mm]{./figuras/resultados1}
	\caption[Resultado 1]{Resultado 1. Figura 1-5: Tratamiento de la imagen para obtener la posición y altura (1: Imagen Depth, 2: Suavizado de Depth, 3: Imagen Binarizada, 4: Detección del contorno, 5: Detección de centroide). Figura 6: Imagen capturada del programa Blender\textcopyright. Figura 7: Proyección desde la perspectiva de la persona}\label{fig:prueba1}
\end{figure}

\begin{figure}[th]
	\centering
	\hspace*{-1cm}
	\includegraphics[width=160mm,height=130mm]{./figuras/resultados2}
	\caption[Resultado 2]{Resultado 2. Figura 1-5: Tratamiento de la imagen para obtener la posición y altura (1: Imagen Depth, 2: Suavizado de Depth, 3: Imagen Binarizada, 4: Detección del contorno, 5: Detección de centroide). Figura 6: Imagen capturada del programa Blender\textcopyright. Figura 7: Proyección desde la perspectiva de la persona}\label{fig:prueba2}
\end{figure}

\begin{figure}[th]
	\centering
	\hspace*{-1cm}
	\includegraphics[width=160mm,height=130mm]{./figuras/resultados3}
	\caption[Resultado 3]{Resultado 3. Figura 1-5: Tratamiento de la imagen para obtener la posición y altura (1: Imagen Depth, 2: Suavizado de Depth, 3: Imagen Binarizada, 4: Detección del contorno, 5: Detección de centroide). Figura 6: Imagen capturada del programa Blender\textcopyright. Figura 7: Proyección desde la perspectiva de la persona}\label{fig:prueba3}
\end{figure}

\begin{figure}[th]
	\centering
	\hspace*{-1cm}
	\includegraphics[width=160mm,height=130mm]{./figuras/resultados4}
	\caption[Resultado 4]{Resultado 4. Figura 1-5: Tratamiento de la imagen para obtener la posición y altura (1: Imagen Depth, 2: Suavizado de Depth, 3: Imagen Binarizada, 4: Detección del contorno, 5: Detección de centroide). Figura 6: Imagen capturada del programa Blender\textcopyright. Figura 7: Proyección desde la perspectiva de la persona}\label{fig:prueba4}
\end{figure}

\begin{figure}[th]
	\centering
	\hspace*{-1cm}
	\includegraphics[width=160mm,height=130mm]{./figuras/resultados5}
	\caption[Resultado 5]{Resultado 5. Segundos subsecuentes de la figura \ref{fig:prueba4} pero con un ligero acercamiento de la persona hacia el escenario}\label{fig:prueba5}
\end{figure}

\begin{figure}[th]
	\centering
	\hspace*{-1cm}
	\includegraphics[width=160mm,height=130mm]{./figuras/resultados6}
	\caption[Resultado 6]{Resultado 6. Figura 1-4: Tratamiento de la imagen para obtener la posición y altura (1: Imagen Depth, 2: Imagen Binarizada, 3: Filtro para excluir persona adicional del entorno, 4: Detección de centroide de la persona principal). Figura 5: Imagen capturada del programa Blender\textcopyright. Figura 7: Proyección desde la perspectiva de la persona}\label{fig:prueba6}
\end{figure}

\begin{figure}[th]
	\centering
	\hspace*{-1cm}
	\includegraphics[width=160mm,height=130mm]{./figuras/resultados7}
	\caption[Resultado 7]{Resultado 7. Figura 1-4: Tratamiento de la imagen para obtener la posición y altura (1: Imagen Depth, 2: Imagen Binarizada, 3: Filtro para excluir persona adicional del entorno, 4: Detección de centroide de la persona principal). Figura 5: Imagen capturada del programa Blender\textcopyright. Figura 7: Proyección desde la perspectiva de la persona acercándose al escenario}\label{fig:prueba7}
\end{figure}

\begin{figure}[th]
	\centering
	\hspace*{-1cm}
	\includegraphics[width=160mm,height=130mm]{./figuras/resultados8}
	\caption[Resultado 8]{Resultado 8. Figura 1-4: Tratamiento de la imagen para obtener la posición y altura (1: Imagen Depth, 2: Imagen Binarizada, 3: Filtro para excluir persona adicional al entorno, 4: Detección de centroide de la persona principal). Figura 5: Imagen capturada del programa Blender\textcopyright. Figura 7: Proyección desde la perspectiva de otra persona}\label{fig:prueba8}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=140mm]{./figuras/anguloKinect1}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=130mm]{./figuras/frontretro}
