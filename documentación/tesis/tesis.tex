...
\subsection{Dispositivos en SAR}
A diferencia de STAR (donde existe una amplia gama de dispositivos utilizados), en SAR se involucran únicamente dos elementos para su correcto uso. Se determina, por lo tanto, que es necesario, un medio por el cual transmitir la información (comúnmente proyectores digitales) y un medio por el cual adquirir datos del entorno físico (sensores).
\subsubsection{Proyectores digitales}
Existe una gran variedad de proyectores digitales, y son diferenciados uno de otros por su nivel de 
\subsubsection{Sensores}
%%
%%Esto del Arte
\section{Estado del arte}
El estudio de visualizar los elementos virtuales tomando la perspectiva respecto a este, es muy reciente.
...
El diseño de un sistema en general, es primordial antes de su implementación para su correcto funcionamiento. Por lo tanto, es de suma importancia, para su futura escalabilidad y optimización, un diseño basado en pequeños módulos en los cuales se realice un análisis y desarrollo de cada una de las partes que estarán involucradas en el sistema.
%%
